#!/usr/bin/env python
#
# gismo documentation build configuration file, created by
...
project = 'Fabien Mathieu Homepage'
...
version = balouf_github_io.__version__
# The full version, including alpha/beta/rc tags.
release = balouf_github_io.__version__
...
"navigation_depth": 1,
    ...
    "icon_links": [
        {
            "name": "LinkedIn",  # Label for screen readers
            "url": "https://www.linkedin.com/in/fmathieu",  # Replace with your LinkedIn profile URL
            "icon": "fab fa-linkedin",  # Font Awesome class for LinkedIn
            "type": "fontawesome",  # Specify that the icon uses Font Awesome
        },
        {
            "name": "GitHub",
...
latex_documents = [
    (master_doc, 'balouf.tex',
     'Balouf Documentation',
